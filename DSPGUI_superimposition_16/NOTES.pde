/*
Replace RingMod2 and add more momentary effects
  multi delay?
  amplitude sample trigger
  
  
Fix having to press play samp twice when changing sampfx



DRAW WAVEFORM DISPLAY TO OFF SCREEN BUFFER
