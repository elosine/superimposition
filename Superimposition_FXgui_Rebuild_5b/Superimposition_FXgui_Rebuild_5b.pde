...
void setup() {
  ...
  properties.setListeningPort(12323);
  properties.setDatagramSize(5136); 
  osc = new OscP5(this, properties);
  sc = new NetAddress("127.0.0.1", 57120);
  me = new NetAddress("127.0.0.1", 12323);
  //TEXT//////////////////////////////////////////
  ...
  //Button Bank 1
  osc.send("/mkbt2", new Object[]{0, 0, 25, 270, 70.0, 50.0, 1, "amplify", 34}, me);
  osc.send("/mkbt2", new Object[]{0, 1, 110, 270, 70.0, 50.0, 1, "greyhole", 24}, me);
  osc.send("/mkbt2", new Object[]{0, 2, 195, 270, 70.0, 50.0, 1, "petals", 28}, me);
  osc.send("/mkbt2", new Object[]{0, 3, 280, 270, 70.0, 50.0, 1, "icy", 10}, me);
  //Button Bank 2
 // osc.send("/mkbt2", new Object[]{1, 100, 450, 270, 70.0, 50.0, 1, "amplify", 34}, me);
 //osc.send("/mkbt2", new Object[]{1, 101, 535, 270, 70.0, 50.0, 1, "greyhole", 24}, me);
 // osc.send("/mkbt2", new Object[]{1, 102, 620, 270, 70.0, 50.0, 1, "petals", 28}, me);
 // osc.send("/mkbt2", new Object[]{1, 103, 705, 270, 70.0, 50.0, 1, "icy", 10}, me);
}//end setup
//DRAW/////////////////////////////////////////////////////////////////
void draw() {
  background(0);
